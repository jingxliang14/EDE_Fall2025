...
library(ggridges) #ridges help build rich plots, help look at the distribution of a variable overtime 

here()

PeterPaul.chem.nutrients <- 
  read.csv(here("/home/guest/EDE_Fall2025/Data/Processed_KEY/NTL-LTER_Lake_Chemistry_Nutrients_PeterPaul_Processed.csv"), stringsAsFactors = TRUE)
...
#work for all code chunks below
# Scatterplot
...
# Fix this code
O3plot2 <- ggplot(EPAair,(aes(x = Date, y = Ozone) )) +
